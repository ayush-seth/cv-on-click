        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:justify-between">
          <div className="max-w-xl space-y-4">
            ...
            <TypographyP>
              ...
              of seasoned professionals understands the pivotal role a CV plays
        ...
        <div className="mt-20 lg:mt-40 lg:flex lg:justify-between lg:gap-10">
          ...
          <div className="mt-8 max-w-xl space-y-8 lg:mt-0 ">
            <TypographyP>
              ...
              processes ourselves, we recognize the significance of a
              well-crafted CV.
            </TypographyP>
            <TypographyP>
        ...
        <div className="mt-10 lg:mt-40 lg:flex lg:justify-between">
          ...
          <div className="mt-10 max-w-xl space-y-8">
            ...
            <TypographyP>
              ...
              with template choices, requiring you to paste or select content
              and then demand a hefty fee for downloading your CV, we take a
              different approach. We believe in a straightforward process - you
              provide your details, and we harness the power of cutting-edge
              technology to create the best possible CV for you.
            </TypographyP>
            <TypographyP>
              Our mission is to empower professionals across India by delivering
              CVs that reflect their skills, experience, and potential in the
              most compelling way. With COC, you can trust that your CV will not
              only meet industry standards but exceed them.
            </TypographyP>
            <TypographyP>
